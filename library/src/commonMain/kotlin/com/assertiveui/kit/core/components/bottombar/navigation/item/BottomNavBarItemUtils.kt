 ...
 * of individual bottom navigation bar items in a custom Bottom Navigation component.
 *
 ...
 */
object BottomNavBarItemUtils {

    /**
     * Modifier extension for styling the container of a Bottom Navigation Bar item.
     *
     ...
     */
    internal fun Modifier.bottomNavBarItemContainerModifier(
        index: Int,
    ...
    /**
     * Modifier extension for styling the icon inside a Bottom Navigation Bar item.
     *
     * Applies animated scaling and vertical offset effects based on interaction states
     * (pressed, hovered, focused) and selection state.
     *
     * @param index The index of the navigation item.
     * @param state The [BottomNavBarState] representing the overall navigation state.
     * @param interactionSource The [MutableInteractionSource] tracking user interactions.
     * @return The updated [Modifier].
     */
    internal fun Modifier.bottomNavBarItemIconModifier(
        index: Int,
        ...
        return composed {
            ...
            val iconOffsetY by animateDpAsState(
                targetValue = if (state.selectedItemIndex == index) (-2).dp else 0.dp,
                animationSpec = spring(
            ...
            Modifier
                .graphicsLayer {
                    this.translationY += with(density) { iconOffsetY.toPx() }
    ...
    /**
     * Composable function that determines the icon color for a Bottom Navigation Bar item.
     *
